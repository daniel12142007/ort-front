        ...
        <div className="flex justify-between w-full">
          <div className="flex items-center w-[40%]">
            <NavLink to="user/homePage">
              <img src={LogoSVG} className="w-[90%] h-[90%] cursor-pointer" alt="Logo" />
            </NavLink>
          </div>
          <div className="flex items-center justify-between w-[60%] text-white font-roboto">
            <NavLink className={({isActive}) => (isActive ? "text-black" : "text-white")} to="user/trainingPage">
              <div className="text-[24px] font-medium">Подготовка к ОРТ</div>
            </NavLink>
            <NavLink className={({isActive}) => (isActive ? "text-black" : "text-white")} to="user/testingPage">
            ...
            <div className="flex items-center space-x-4">
              ...
              <img src={ProfileSVG} className="w-[50px] h-[50px] rounded-full" alt="Profile" />
            </div>
          </div>
        </div>
      </Container>
