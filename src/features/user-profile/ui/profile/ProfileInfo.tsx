  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col items-center p-5 gap-3">
        <Avatar name={person.name} size={100} photoUrl={person.image} />
