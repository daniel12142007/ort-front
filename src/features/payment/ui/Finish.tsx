...
const Finish = () => {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bottom-0 w-full flex justify-center items-center">
      <div className="bg-white p-5 rounded-2xl w-10/12 sm:w-2/5 shadow-lg">
          ...
          {isSuccess ? (
            <>
              <div className="w-full">
                ...
                <div className="border-b px-5 py-2 text-lg text-gray-600">Сумма: <b className="text-black"> 1260 сом</b>
                </div>
